...
![**Рис. 1** Структурная схема ЭВМ](image/Screenshot1.png){ #fig:001 width=70% }
...
![**Рис. 2** 64-битный регистр процессора ‘RAX’](image/Screenshot2.png){ #fig:002 width=70% }
...
![**Рис. 3** 64-битный регистр процессора ‘RAX’](image/Screenshot3.png){ #fig:003 width=70% }
...
![**Рис. 4** Процесс создания ассемблерной программы](image/Screenshot4.png){ #fig:004 width=70% }
...
![**Рис. 5**](image/Screenshot5.png){ #fig:004 width=70% }

Создал текстовый файл с именем hello.asm

Открыл этот файл в текстовом редакторе и вписал текст (рис. [-@fig:005])

![**Рис. 6**](image/Screenshot6.png){ #fig:005 width=70% }

Скомпилировал файл в hello.o (рис. [-@fig:005])

![**Рис. 7**](image/Screenshot7.png){ #fig:006 width=70% }

Скомпилировал файл в obj.o (рис. [-@fig:006])

![**Рис. 8**](image/Screenshot8.png){ #fig:007 width=70% }

Создал исполняемый файл (рис. [-@fig:007])

![**Рис. 9**](image/Screenshot8.png){ #fig:008 width=70% }

Скомпоновал файл в main (рис. [-@fig:008])


# Выводы

Assembler nasm – низкоуровневый ЯП, для работы с которым необходимо вручную компилировать и создавать исполняемые файлы.
